...
namespace tmp102
{
    ...
    class Program
    {
        public static void ShowSpecialSymbols(Hd44780 lcd)
        {
            ...
            var bell = new byte[] { 0x04, 0x0e, 0x0e, 0x0e, 0x1f, 0x00, 0x04 };
            var note = new byte[] { 0x02, 0x03, 0x02, 0x0e, 0x1e, 0x0c, 0x00 };
            var clock = new byte[] { 0x00, 0x0e, 0x15, 0x17, 0x11, 0x0e, 0x00 };
            var heart = new byte[] { 0x00, 0x0a, 0x1f, 0x1f, 0x0e, 0x04, 0x00 };
            var duck = new byte[] { 0x00, 0x0c, 0x1d, 0x0f, 0x0f, 0x06, 0x00 };
            var check = new byte[] { 0x00, 0x01, 0x03, 0x16, 0x1c, 0x08, 0x00 };
            var cross = new byte[] { 0x00, 0x1b, 0x0e, 0x04, 0x0e, 0x1b, 0x00 };
            var retArrow = new byte[] { 0x01, 0x01, 0x05, 0x09, 0x1f, 0x08, 0x04 };
